...
const ConversationList = ({ onConversationSelect, selectedConversation }: ConversationListProps) => {
    ...
    const showConversations = !isLoading && conversations.length > 0
    ...
    return (
        <div className="w-full flex flex-col gap-4 bg-background max-h-[90vh] py-4 sm:py-10 px-4 sm:px-9 overflow-hidden">
